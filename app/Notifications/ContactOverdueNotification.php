...
/**
 * Уведомление лидеру при автоматической просрочке обработки контакта.
 */
class ContactOverdueNotification extends Notification
{
    ...
    public function toDatabase(object $notifiable): array
    {
        ...
        return FilamentNotification::make()
            ->warning()
            ->title('Контакт просрочен по обработке')
            ->body($body)
