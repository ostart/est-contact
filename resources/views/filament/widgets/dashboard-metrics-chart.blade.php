...
<x-filament-widgets::widget class="fi-wi-chart">
    ...
    >
        ...
        <div
            ...
            @endif
            wire:key="dashboard-metrics-chart-{{ $this->getChartStateKey() }}"
            x-data="{
                observeSection() {
                    ...
                    const observer = new MutationObserver(() => {
                        if (! section.classList.contains('fi-collapsed')) {
                            refresh()
                        }
                    })
                    ...
                    section.querySelector('.fi-section-header')?.addEventListener('click', () => {
        ...
        >
            ...
            >
                <canvas
                    x-ref="canvas"
                    @if ($maxHeight)
                        style="height: {{ $maxHeight }}; min-height: {{ $maxHeight }}; width: 100%;"
                    @endif
                ></canvas>
